...
public sealed class BankaHareketConfiguration : IEntityTypeConfiguration<BankaHareket>
{
    public void Configure(EntityTypeBuilder<BankaHareket> builder)
    {
        ...
        builder.HasOne(x => x.Banka)
            .WithMany()
            .HasForeignKey(x => x.BankaId)
        ...
        builder.HasIndex(x => new { x.TenantId, x.SubeId, x.BankaId, x.HareketTarihi });
