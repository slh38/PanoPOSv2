...
public sealed class PanoPosDbContext : DbContext
{
    ...
    public DbSet<StokKart> StokKartler => Set<StokKart>();
    public DbSet<StokKategori> StokKategorileri => Set<StokKategori>();
    public DbSet<FiyatTipi> FiyatTipleri => Set<FiyatTipi>();
    public DbSet<StokKartSatisBirimi> StokKartSatisBirimleri => Set<StokKartSatisBirimi>();
    public DbSet<StokKartFiyat> StokKartFiyatlari => Set<StokKartFiyat>();
    public DbSet<StokGrup> StokGruplari => Set<StokGrup>();
